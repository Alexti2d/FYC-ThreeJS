import * as THREE from "three";
      ...
      let camera, scene, renderer, parentHolo, maLampe, monEcran;
      ...
      function init() {
        ...
        camera.position.set(0.01713, 0.5867, 0.9618);
        camera.lookAt(0, 1, 0);
        ...
        document.addEventListener( 'mousemove', onMouseMove );
          ...
          const intersectionEcran = raycaster.intersectObject( monEcran );
            ...
            camera.position.set(-0.02189168485031384, 0.2317157782473293, 0.5531018786903674);
            camera.rotation.set(-0.052991232297638365, 0.06516297781261929, 0.003453843033196438);
					}		
				  });
      }
